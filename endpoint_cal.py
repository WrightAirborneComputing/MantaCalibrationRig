...
import servo_probe
from manta_common import find_pico_port, report_path
...
MOVEMENT_THRESHOLD_DEG = 0.25      # above the 0.23-0.27 deg noise floor measured
...
# The wide-open range stage 1 creeps across.
COARSE_MIN = 900
COARSE_MAX = 2100
